...
const featuredCalculators = [
  ...
  },
  {
    ...
    description: 'Estimate your retirement savings growth with employer matching and tax benefits.',
    icon: PiggyBank,
    badges: ['Tax Scenarios', 'Projections'],
  },
  {
    title: 'Investment Return Calculator',
    description: 'Calculate compound returns, ROI, and future value of your investments over time.',
    icon: TrendingUp,
    badges: ['Compound Interest', 'Charts'],
  },
  {
    title: 'Credit Card Payoff Calculator',
    description: 'Find out how long it will take to pay off credit card debt and save on interest.',
    icon: CreditCard,
    badges: ['Payoff Strategy', 'Interest Savings'],
  },
  {
    title: 'Loan Calculator',
    description: 'Compare loan options with detailed breakdowns of principal and interest payments.',
    icon: DollarSign,
    badges: ['APR Comparison', 'Payment Schedule'],
  },
  {
    title: 'Retirement Savings Calculator',
    description: 'Plan for retirement with Social Security, pensions, and investment projections.',
    icon: Calculator,
...
const benefits = [
  {
    ...
    description: 'Every calculation is based on standard US financial formulas and regularly validated.',
    icon: CheckCircle2,
  },
  {
    title: 'Complete Transparency',
    description: 'See exactly how results are calculated with detailed breakdowns and assumptions.',
    icon: Eye,
  },
  {
    title: 'Privacy First',
    description: 'No tracking, no data collection. Your financial information stays on your device.',
    icon: Lock,
  },
  {
    title: 'Export & Share',
    description: 'Download results as PDF or Excel, or share calculations with your advisor.',
    icon: FileDown,
  },
];
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg font-medium leading-relaxed text-foreground/80 sm:text-xl">
              Fast, accurate, and easy-to-understand tools for smarter money decisions in the US.
            </p>

            {/* Search Bar */}
            <div className="mx-auto mt-8 max-w-2xl">
              <SearchBar onSelect={(calc) => router.push(`/calculators/${nameToSlug(calc)}`)} />
            </div>
