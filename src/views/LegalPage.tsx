        ...
        <div className="prose prose-sm max-w-none dark:prose-invert">
          ...
          {title === "Privacy Policy" ? (
            <>
              ...
              <p className="text-muted-foreground">
                SmartCalcLab is committed to protecting your privacy. We&apos;ve
                designed our calculators to perform all computations locally in
              ...
              <p className="text-muted-foreground">
                We collect minimal technical information necessary to deliver
                the service:
              </p>
              <ul className="text-muted-foreground">
                <li>
                  <strong>Server Logs:</strong> Basic access logs (IP address,
                  browser type, pages visited) are temporarily stored for
                  security and debugging purposes, then deleted after 7 days.
                </li>
                <li>
                  <strong>No Cookies:</strong> We do not use tracking cookies.
                  We may use essential cookies only for core functionality (like
                  theme preference).
                </li>
              </ul>
              ...
              <p className="text-muted-foreground">
                ...
                to request, delete, or export. Your calculations are yours
                alone.
              </p>
            ...
            <>
              ...
              <p className="text-muted-foreground">
                All calculators are provided for educational and informational
                purposes only. They are not intended as financial, legal, or tax
                advice. Always consult qualified professionals for guidance
              ...
              <p className="text-muted-foreground">
                ...
                completeness, reliability, or accuracy of the calculations. Use
                results at your own risk.
              </p>

              <h3 className="mt-6 text-foreground">3. No Liability</h3>
              <p className="text-muted-foreground">
                SmartCalcLab and its operators are not liable for any decisions
                made or actions taken based on information from our calculators.
              </p>

              <h3 className="mt-6 text-foreground">4. Free Service</h3>
              <p className="text-muted-foreground">
                SmartCalcLab is provided free of charge. We reserve the right to
              ...
              <p className="text-muted-foreground">
                ...
                access it through automated means that could damage or impair
                functionality.
              </p>

              <h3 className="mt-6 text-foreground">6. Embedding</h3>
              <p className="text-muted-foreground">
                You may embed our calculators on your website with proper
                attribution. See our Embed page for details.
              </p>
