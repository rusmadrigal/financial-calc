      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg text-muted-foreground">
            Complete high-trust financial calculator website with professional
            fintech design system. All pages are fully responsive for desktop
            (1440px) and mobile (390px) viewports.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Button
              variant="outline"
              onClick={() => router.push("/states-demo")}
            >
              States Demo
            </Button>
          </div>
