...
export function RefinanceCalculator() {
  ...
  }, [currentBalance, currentRate, remainingYears, newRate, newTermYears, closingCosts]);
  ...
  const tableRows = result.scheduleNew.map((row) => [
    row.period,
                ...
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={chartData}>
                      ...
                      />
                      <Bar dataKey="current" fill="var(--chart-2)" name="Current" />
