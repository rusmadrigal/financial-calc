...
import { calculateIRA } from "@/lib/helpers/financial/calculateIRA";
...
export function IRACalculator() {
  ...
  const handleExportPDF = () => {
    if (!hasResults) return;
    exportToPDF("IRA Calculator", summaryData, tableHeaders, tableRows);
    toast.success("PDF downloaded");
  };

  const handleExportExcel = () => {
    if (!hasResults) return;
    exportToExcel("IRA Schedule", tableHeaders, tableRows);
    toast.success("Excel file downloaded");
  };

  const handleDownloadFullSchedule = () => {
    if (!hasResults) return;
    exportToCSV("IRA-Full-Schedule", tableHeaders, tableRows);
        ...
        <div className="lg:col-span-1">
          <Card className="sticky top-24">
            <CardHeader>
              ...
              <CardDescription>Traditional IRA assumptions</CardDescription>
            </CardHeader>
