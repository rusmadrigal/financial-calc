...
import {
  ...
  type DebtEntry,
} from "@/lib/helpers/financial/calculateDebtAvalanche";
...
export function DebtAvalancheCalculator() {
  ...
  const handleDownloadFullSchedule = () => {
    ...
    exportToCSV("Debt-Avalanche-Full-Schedule", headers, rows);
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-1">
          <Card className="sticky top-24">
            <CardHeader>
              ...
              <CardDescription>Debts (highest APR first)</CardDescription>
            </CardHeader>
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <Alert>
            ...
            <AlertDescription>
              Avalanche: pay minimums on all debts and put extra toward the
              highest APR first. Usually saves more interest than snowball.
            </AlertDescription>
          </Alert>
