...
export function Plan529Calculator() {
  ...
  const handleExportPDF = () => {
    exportToPDF("529 Plan Calculator", summaryData, tableHeaders, tableRows);
    toast.success("PDF downloaded");
  };
  const handleExportExcel = () => {
    exportToExcel("529 Plan", tableHeaders, tableRows);
  ...
  return (
    <>
        ...
        <div className="lg:col-span-1">
          <Card className="sticky top-24">
            <CardHeader>
              ...
              <CardDescription>529 savings target</CardDescription>
            </CardHeader>
        ...
        <div className="space-y-6 lg:col-span-2">
          <Card className="border-2">
            <CardHeader>
              ...
              <CardDescription>529 projected balance</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>529 balance by year</CardDescription>
                </CardHeader>
                <CardContent>
      ...
      <Alert className="mt-8 border-2 border-destructive/50 bg-destructive/5">
        ...
        <AlertDescription>
          Estimate only. Consult a financial or tax advisor.
        </AlertDescription>
      </Alert>
    </>
  );
