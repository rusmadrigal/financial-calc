...
import { calculateSavings } from "@/lib/helpers/financial/calculateSavings";
...
export function SavingsCalculator() {
  ...
  const result = useMemo(() => {
    return calculateSavings({
      initialDeposit: Math.max(0, parseFloat(initialDeposit) || 0),
  ...
  const handleExportPDF = () => {
    if (!hasResults) return;
    exportToPDF("Savings Calculator", summaryData, tableHeaders, tableRows);
    toast.success("PDF downloaded");
  };

  const handleExportExcel = () => {
    if (!hasResults) return;
    exportToExcel("Savings Schedule", tableHeaders, tableRows);
    toast.success("Excel file downloaded");
  };

  const handleDownloadFullSchedule = () => {
    if (!hasResults) return;
    exportToCSV("Savings-Schedule", tableHeaders, tableRows);
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-1">
          <Card className="sticky top-24">
            <CardHeader>
              ...
              <CardDescription>Savings assumptions</CardDescription>
            </CardHeader>
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <Alert>
            ...
            <AlertDescription>
              Projected growth with compound interest. Actual rates vary.
            </AlertDescription>
          </Alert>
