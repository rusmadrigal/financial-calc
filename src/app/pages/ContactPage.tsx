      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4 text-muted-foreground">
          ...
          <div className="mt-8 rounded-lg border-2 border-border bg-card p-8">
            ...
            <p className="text-sm">
              We typically respond within 1-2 business days. For calculator suggestions, please
              include the type of calculation you need and what information you&apos;d like to see in the
              results.
            </p>
          </div>
        </div>
